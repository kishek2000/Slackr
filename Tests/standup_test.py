...
from functions.helper_functions import (check_standup_active, start_standup, end_standup,
                                        add_to_standup_queue, standup_status, reset_data)
...
def test_standup_invalid_helpers(_setup):
    ...
    assert check_standup_active(-1) is False
...
def test_standup_start_correct_time_difference_3_minute(_setup):
    ...
    time_finish = standup_start(user_1_token, channel_id, 3)
...
def test_standup_start_correct_time_difference_15_minute(_setup):
    ...
    time_finish = standup_start(user_1_token, channel_id, 15)
...
def test_standup_active_invalid(_setup):
    '''Testing standup_active with inactive standup'''
    #Start the standup on the channel with channel id 'channel_id_user_1'
    ...
    assert standup_active(user_token, channel_id_1)['standup_active'] is False
...
def test_standup_send_standup_time_finished_1_minute(_setup):
