...
def registered_user_1():  
    ...
    user_details = auth_register("PokemonMaster@gmail.com", 
                                 "validP@sswrd1", 
                                 "Ash",
                                 "Ketcham")      
...
def test_auth_register_correct_details():
    ...
    #Should produce no errors
    user_details_1 = auth_register(email_1, password_1, 
                                   name_first_1, name_last_1)
    user_details_2 = auth_register(email_2, password_2, 
                                   name_first_2, name_last_2)
...
def test_auth_register_first_and_last_name_long_handler():
    ...
    user_details = auth_register(email, password, name_first,
                                 name_last)         
...
def test_auth_passwordreset_request_valid_email_provided(registered_user_1):
    ...
    auth_passwordreset_request(reset_email)  
