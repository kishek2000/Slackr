...
sys.path.append('..')
from ..Server.functions.channel_functions import channel_addowner, channel_details, channel_invite, channel_join, channel_leave, channel_messages, channel_removeowner, channels_create, channels_list, channels_listall, reset_data, reset_channel_data, get_name_from_token, all_channels_details, list_of_users, change_user_permission, get_user_from_token, get_total_channel_messages, get_channel_id_from_name 
from ..Server.functions.auth_functions import auth_register
from ..Server.functions.message_functions import message_send
